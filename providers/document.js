...
DocumentProvider = function(host, port, fn) {
...
DocumentProvider.prototype.getCollection = function(fn) {
	this.db.collection(this.collectionName, fn);
};

DocumentProvider.prototype.documentGet = function(name, fn) {
...
DocumentProvider.prototype.documentAdd = function(user, fn) {
